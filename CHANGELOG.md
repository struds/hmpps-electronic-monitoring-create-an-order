...
PR: [#388](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/388) and PR: [#378](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/378)
...
PR: [#377](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/377)
...
PR: [#388](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/388)
...
PR: [#375](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/375)
...
PR: [#365](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/365)
...
PR: [#352](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/352)

---

**February 29th 2024** – Use same node version for outdated check and security scan. This currently defaults to node 16

PR: [#321](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/321)

---

**February 15th 2024** – Move over to use Debian 12 based image (bookworm)

PR: [#316](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/316)
...
PR: [#297](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/297)
...
PR: [#274](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/274)

---

**November 29th 2023** – Use in-memory token store when developing locally

PR: [#273](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/273)

---

**November 6th 2023** – Add HMPPS Manage Users API to health checks

PR: [#255](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/255)
...
PR: [#252](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/252)
...
PR: [#249](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/249)
...
PR: [#247](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/247)
...
PR: [#238](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/238)
...
PR: [here](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/231)
...
PR: [here](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/212)
...
PR: [here](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/197)
...
PR: [here](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/178)
...
PR: [here](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/172)
...
PR: [here](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/170)
...
PR: [here](https://github.com/ministryofjustice/hmpps-electronic-monitoring-create-an-order/pull/149)
