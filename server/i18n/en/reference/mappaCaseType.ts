import MappaCaseType from '../../../types/i18n/reference/mappaCaseType'

const mappaCaseType: MappaCaseType = {
  'SOC (Serious Organised Crime)': 'Serious Organised Crime',
  'TACT (Terrorism Act, Counter Terrorism)': 'Terrorism Act, Counter Terrorism',
